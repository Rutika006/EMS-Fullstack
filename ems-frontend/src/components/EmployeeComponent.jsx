...
const [errors,setErrors]=useState({
 ...
 function validateForm(){
    ...
    if(email.trim()){
      ...
      errorsCopy.email='Email id required';
      valid=false;
    }
                 ...
                 <div className="card-body">
                    <form>
                        ...
                        <div className="form-group">
                               ...
                               <input type="email" placeholder='Enter Employee Email Id' name='email' value={email} className={`form-control ${errors.email ? 'is-invalid': ''}`}  onChange={handleEmail}/>
